    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-stone-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-stone-800 mb-2">MARÉ</h1>
          <p className="text-stone-600">Catálogo Mayorista</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-amber-600 text-white py-3 rounded-lg font-medium hover:bg-amber-700 transition-colors focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
          >
            Acceder al Catálogo
          </button>
        </form>
...
const App = () => {
  ...
  // Cargar datos de productos (simulado - en producción cargarías desde Excel)
  useEffect(() => {
    ...
    const sampleProducts: Product[] = [
      {
        ...
        descripcion: 'Cinto elegante para dama',
        categoria: 'Cinto de dama',
        medidas: '95cm',
        precio: 135,
        imagenes: ['LB010 1.jpg', 'LB010 2.jpg'],
        imagenVariantes: 'LB010 VARIANTES.jpg',
        sinColor: false,
      ...
      },
      {
        ...
        medidas: '110cm',
        precio: 180,
        imagenes: ['MB001 1.jpg', 'MB001 2.jpg'],
        imagenVariantes: 'MB001 VARIANTES.jpg',
        sinColor: false,
        permitirSurtido: true,
        estado: 'visible',
        colores: {},
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-95 z-[60] flex items-center justify-center">
      ...
      <div className="relative w-full h-full flex items-center justify-center p-16">
        ...
        >
          <img
            src={`/imagenes/${product.imagenes[currentImageIndex]}`}
      ...
      <div className="p-4 space-y-3">
        ...
        {product.imagenVariantes && (
          <div className="border rounded-lg overflow-hidden">
            <img
              src={`/imagenes/${product.imagenVariantes}`}
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <h2 className="text-xl font-bold text-stone-800">Tu Pedido</h2>
                ...
                <div key={index} className="border border-stone-200 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-sm text-stone-600">{item.producto.codigo}</p>
                      <p className="text-sm font-medium text-amber-600">${item.producto.precio}</p>
                    </div>
                    <button
